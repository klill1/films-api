...
<div class="container">
    ...
    {{message}} <br/>
        ...
        <div class="row">
            ...
            <div class="col-75">
                <input type="text" id="description" v-model="description" placeholder="Kirjeldus" required>
            </div>
        </div>
        <div class="row">
            <div class="col-25">
            ...
            <div class="col-75">
                <input id="releaseDate" type="date" v-model="releaseDate" placeholder="Kuupäev" style="height:50px" required />
            </div>
        </div>
        <br>
        <div class="row">
